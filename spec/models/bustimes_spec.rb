...
describe Bustime do
	...
	describe "busdirections" do
		...
		it "should return North Bound as one of the directions for the 147 route" do
			@busdirections.select { |dir| dir["dir"] == "North Bound"}.length().should equal 1
		end
	...
	describe "busstops" do
		...
		before { @busstops = Bustime.new.busstops(147,'North Bound') }
	...
	describe "buspredictions" do
		before { @buspredictions = Bustime.new.buspredictions(147,'North Bound',1125) }
